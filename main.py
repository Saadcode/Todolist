...
def main() :
    ...
    send = tkinter.Button(app, text='Add', fg="#ffffff", bg='#6186AC', height=4, width=45, command=get_entry)
    quit = tkinter.Button(app, text='Exit', fg="#ffffff", bg='#EB6464', height=3, width=40, command=app.destroy)
